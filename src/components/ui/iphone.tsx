...
export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  ...
  /** Fill color for phone body/chassis (e.g. '#d94404' for orange) */
  bodyColor?: string;
  /** Fill color for Dynamic Island / floating dock (e.g. '#000000' for black) */
...
export function Iphone({
  ...
  const bodyFill = bodyColor ?? '#E5E5E5';
  const dynamicIslandFill = dynamicIslandColor ?? '#E5E5E5';
      ...
      >
        <g mask={hasMedia ? 'url(#screenPunch)' : undefined}>
          ...
          <path
            ...
            fill={bodyColor ? bodyFill : undefined}
            className={!bodyColor ? 'fill-white dark:fill-[#262626]' : undefined}
          />
        </g>

        <path
          opacity={dynamicIslandColor ? '1' : '0.5'}
          d="M174 5H258V5.5C258 6.60457 257.105 7.5 256 7.5H176C174.895 7.5 174 6.60457 174 5.5V5Z"
          fill={dynamicIslandFill}
        />
